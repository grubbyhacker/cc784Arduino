...
</script></head><body onload="showinfomessage();"> <header id="header"> <div class="innertube"> <h1>Color Cells 784</h1> </div> </header> <iframe id="result" name="result" onload= "doloaded();"></iframe> <div class="resultsmessage" id="loadingMessage"> Command is running.... </div> <div id="wrapper"> <main> <div id="content"> <div class="innertube"> <h1>WIFI Enabled CC784</h1> <p></p> <h3 id="message">Change Message</h3> <p></p>Add markup to your message using an underscore and a four letter command. For example: This is a _BOLDbold_NORM word.<form action="/program" method="get" target="result"><br> Select a message bank: <select name="bank"> <option value="0"> 0 </option> <option value="1"> 1 </option> <option value="2"> 2 </option> <option value="3"> 3 </option> <option value="4"> 4 </option> <option value="5"> 5 </option> <option value="6"> 6 </option> <option value="7"> 7 </option> <option value="8"> 8 </option> <option value="9"> 9 </option> </select><br> <textarea maxlength="300" name="msg">Enter text here...</textarea><br> <input onclick="doloading();" type="submit" value= "Submit"> </form> <h3 id="sequence">Sequence Messages</h3>There are 10 banks of messages, numbered 0-9. You can schedule which banks of messages will be displayed in any order. Repeats are allowed. For instance: <ul><li>01234 will sequence the first 5 banks.</li><li>99994 will repeat bank 9 four times, then play bank 4.</li></ul>There is a limit of 32 items in the sequence. <p></p> <form action="/sequence" method="get" target="result">Input your sequence: <input type="text" name="seq"><input onclick="doloading();" type="submit" value= "Submit"> </form> <h3 id="settime">Set the Time</h3> The CC784 has a realtime clock and can display the time in a message.<p></p> <form action="/settime" method="get" target="result"> Four-digit 12-h time: [hhmm] <input type="text" name="time"> <select name="am"> <option value="N">PM</option> <option value="Y">AM</option> </select> <input onclick="doloading();" type="submit" value="Submit"> </form> <h3 id="metrics">Serving Metrics</h3> <table class="myTable"> <tr> <th>Metric</th> <th>Value</th></tr>)V0G0N";

/*
 *  This chunk closes out the table and the rest of the file.
 *
 */
const char root_footer[] PROGMEM = R"V0G0N(</table> </div> </div> </main> <nav id="nav"> <div class="innertube"> <h3>Commands</h3> <ul> <li> <a href="/stop" onclick="doloading();" target="result">Stop</a> </li> <li> <a href="/run" onclick="doloading();" target="result">Run</a> </li> <li> <a href="/rebootdisplay" onclick="doloading();" target= "result">Reboot Sign</a> </li> <li> <a href="/signoff" onclick="doloading();" target= "result">Turn Sign Off</a> </li> <li> <a href="/signon" onclick="doloading();" target= "result">Turn Sign On</a> </li> <li> <a href="#message">Change Message</a> </li> <li> <a href="#sequence">Sequence</a> </li> <li> <a href="#settime">Set the time</a> </li> </ul> <h3>Information</h3> <ul> <li> <a href="#metrics">Serving Metrics</a> </li> <li> <a href="https://github.com/grubbyhacker/cc784Arduino" target="_blank">Help</a> </li> </ul> </div> </nav> </div> <footer id="footer"> <div class="innertube"> <p></p> </div> </footer></body></html>)V0G0N";
